...
// MUI Assets
import { Box, Button, Divider, Fade, TextField, Typography, useMediaQuery, useTheme} from '@mui/material';
...
type PassoProps = {
  ...
  setDepartamento?: React.Dispatch<React.SetStateAction<{nome: string, gestor: string;}>>,
    ...
    <>
      <Box sx={{
        ...
        <Typography data-aos="fade-right" data-aos-duration='500' sx={{
          ...
          <Typography component="span" sx={{ml: 2, color: 'text.secondary', fontWeight: 600 }}>Novo departamento</Typography>
        ...
        <Box sx={{
          ...
          {passo === 1 && <PassoUm departamento={departamento} fireErrorBtn={fireErrorBtn} form={form} setDepartamento={setDepartamento} passo={passo}/>}
          {passo === 2 && <PassoDois departamento={departamento} fireErrorBtn={fireErrorBtn} form={form} setForm={setForm} passo={passo}/>}
          {passo === 3 && <PassoTres/>}
...
const StepTab = ({passo} : StepProps) => {
  ...
  return (
          ...
          <Typography sx={{
            fontWeight: '600',
            fontSize: '15px'
          }}>Definir departamento</Typography>
